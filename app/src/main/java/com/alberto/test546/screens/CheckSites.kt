...
import com.alberto.test546.components.TextFieldCustom
...
@Composable
fun CheckSites( navController: NavController) {
        ...
        AnimatedBorderCard(
            ...
            Column(
                ...
                TextFieldCustom(
                    ...
                    hint = stringResource(id = R.string.txt_inserir_url),
                ...
                Button(
                    onClick = {
                              if(urlText.startsWith("https://")){
                                  navController.navigate("Verificado")
                              }else{
                                  navController.navigate("NaoVerificado")
                              }
                    },
                    modifier = Modifier
                        .width(400.dp)
                    ...
                    Text(
                        text = stringResource(id = R.string.txt_button_verificar),
                        fontSize = 18.sp
                    )
                }
